...
let find_inputs =G.find_inputs
let find_output = G.find_output

let add_node = G.add_node
let is_executable = G.is_executable

let get_all_outputs = G.get_all_outputs
let get_all_inputs = G.get_all_inputs

let get_all_free_inputs = G.get_all_free_inputs

let get_executable_nodes = G.get_executable_nodes


type tensorstate = G.tensorstate 